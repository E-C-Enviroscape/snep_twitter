...
write.csv(mar11_snep,"mar11_snep.csv", row.names = FALSE)
...
write.csv(mar11_freq,"mar11_freq.csv", row.names = FALSE)
...
write.csv(allsnep_freq,"allsnep_freq.csv", row.names = FALSE)
...
allsnep_plot
ggsave("allsnep_plot.png", dpi = 200)
